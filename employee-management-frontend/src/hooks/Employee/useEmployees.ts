...
interface UseEmployeesActions {
  createEmployee: (employee: CreateEmployeeInput) => Promise<void>;
...
function useEmployees(): UseEmployeesReturn {
  ...
  async function createEmployee(employee: CreateEmployeeInput): Promise<void> {
    try {
      setState((previous) => ({
        ...previous,
        isCreating: true,
  ...
  async function updateEmployee(id: number, employee: CreateEmployeeInput): Promise<void> {
    try {
      setState((previous) => ({
        ...previous,
        isUpdating: true,
